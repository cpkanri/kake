...
## 5. 最終 HEAD
- commit: **`95a35b3300d2eb376cd8f173117ec9e120d02c12`**（短縮 `95a35b3`）。`5db5754..95a35b3` を `cpkanri/kake` main へ push 済み。
- 内容: `index.html`（fixReportBlankZeros/guardIndexBlank 追加）+ `sw.js`（v41→v42）+ 本報告。
